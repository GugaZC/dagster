...
class SpecificPartitionsPartitionMapping(
    PartitionMapping,
    NamedTuple(
        "_SpecificPartitionsPartitionMapping",
...
class MultiToSingleDimensionPartitionMapping(
    ...
    PartitionMapping,
    NamedTuple(
        "_MultiToSingleDimensionPartitionMapping",
        [("partition_dimension_name", Optional[str])],
    ),
):
...
class DynamicPartitionMapping(
    ...
    def get_downstream_partitions_for_partitions(
        ...
        upstream_partition_keys = set(upstream_partitions_subset.get_partition_keys())
        expected_downstream = {
            map_[0] for map_ in dynamic_mapping if set(map_[1]) & upstream_partition_keys
        }
